...
func main() {
	...
	// so the registry survives operator restarts. Best effort: a missing
	// CRD (first install) is not fatal.
	{
		...
		} else if serr := controller.SeedRegistry(seedCtx, directClient, reg); serr != nil {
